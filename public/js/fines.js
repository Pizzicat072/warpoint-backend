...
function initFines() {
    ...
    if (statusFilter) statusFilter.addEventListener('change', (e) => {
        currentFineStatusFilter = e.target.value;
        renderFinesTable();
    });
    if (employeeFilter) employeeFilter.addEventListener('change', (e) => {
        currentFineEmployeeFilter = e.target.value;
        renderFinesTable();
    });
    if (typeFilter) typeFilter.addEventListener('change', (e) => {
        currentFineTypeFilter = e.target.value;
        renderFinesTable();
    });
    if (monthFilter) monthFilter.addEventListener('change', (e) => {
        currentFineMonthFilter = e.target.value;
        renderFinesTable();
    });
